...
its Lean proof files. The publication preserves other chapters and adds only
three missing root Section 3 proof modules. See
[MAIN_INTEGRATION.md](MAIN_INTEGRATION.md) for the source-identity check and
exact scope. This is not a claim of a new whole-main compilation.
