...
Physical matrices in Section 10 already include their variance normalization.
...
namespace BernoulliSection10.Replacement

open BernoulliSection10.ProbabilityLimits TaoVuReplacement
...
theorem physical_replacement_of_logPotential_limits
  ...
  simpa only [A, B, normalizedMatrix_undoPhysicalNormalization] using
    BernoulliSection10.DimensionReplacement.taoVuReplacementPrinciple_sequence P A B hA hB hHS hlog


end BernoulliSection10.Replacement
