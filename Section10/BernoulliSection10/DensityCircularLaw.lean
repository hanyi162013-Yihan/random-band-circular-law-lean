...
The only random-matrix theorem parameters are the exact Section 3 inputs.
...
The last theorem uses just an infinite sequence of real IID atoms. Its
...
/-- Theorem 2.10, real-IID bounded-density finite-third-moment branch,
