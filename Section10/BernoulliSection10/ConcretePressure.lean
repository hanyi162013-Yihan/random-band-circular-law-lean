...
def intervalPressure (μ : Measure ℝ) (W s : ℕ) (z : ℂ)
    (r : Fin (2 * W + 1)) : ℝ :=
...
def intervalMaxPressure (μ : Measure ℝ) (W s : ℕ) (z : ℂ) : ℝ :=
  finitePressureMax (intervalPressure μ W s z)

def densityCorePressure (μ : Measure ℝ) (W : ℕ) (z : ℂ)
    (r : Fin (2 * W + 1)) : ℝ :=
  intervalPressure μ W (densityCoreSites W) z r

def densityMaxCorePressure (μ : Measure ℝ) (W : ℕ) (z : ℂ) : ℝ :=
  finitePressureMax (densityCorePressure μ W z)

def densityOptimizingDegree (μ : Measure ℝ) (W : ℕ) (z : ℂ) : Fin (2 * W + 1) :=
  pressureOptimizingDegree (densityCorePressure μ W z)

theorem densityOptimizingDegree_maximizes (μ : Measure ℝ) (W : ℕ) (z : ℂ) :
...
theorem densityOptimizingDegree_minimal (μ : Measure ℝ) (W : ℕ) (z : ℂ)
    {r : Fin (2 * W + 1)}
