...
theorem multiAffineHeadEval_add
    ...
    {p : ℕ} {ps : List ℕ}
    (c d : MultiAffineTensor E (p :: ps)) (x : Fin p → ℝ) :
...
theorem multiAffineHeadEval_neg
    {E : Type*} [NormedAddCommGroup E] [NormedSpace ℝ E]
    {p : ℕ} {ps : List ℕ}
    (c : MultiAffineTensor E (p :: ps)) (x : Fin p → ℝ) :
...
theorem multiAffineHeadEval_smul
    {E : Type*} [NormedAddCommGroup E] [NormedSpace ℝ E]
    {p : ℕ} {ps : List ℕ}
    (t : ℝ) (c : MultiAffineTensor E (p :: ps)) (x : Fin p → ℝ) :
...
theorem multiAffineEval_smul
    {E : Type*} [NormedAddCommGroup E] [NormedSpace ℝ E] :
    ∀ {ps : List ℕ} (t : ℝ) (c : MultiAffineTensor E ps)
      (x : MultiAffineRows ps),
