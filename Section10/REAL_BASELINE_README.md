# Historical real-IID conditional baseline

For the current real/planar source-connected entry points, use
[README.md](README.md). The text below preserves the earlier real endpoint
and its `Section3Inputs` boundary; it is not the current final interface.
